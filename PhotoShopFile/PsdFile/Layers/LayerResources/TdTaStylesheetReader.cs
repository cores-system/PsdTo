...
namespace PhotoshopFile.LayerResources
{
    public class TdTaStylesheetReader
    {
        ...
        protected List<int> GetRunLengthArray(string baseSelector)
        {
            ...
            foreach (object o in a) n.Add(Convert.ToInt32(o.ToString()));
            return n;
        }
        ...
        /// StyleSheetData
        /// </summary>
        public Dictionary<string, object> GetStyleSheetSet()
        {
            var mass = TdTaParser.getList(tree, "ResourceDict.StyleSheetSet");
            return ((dynamic)mass[0])["StyleSheetData"];
        }
