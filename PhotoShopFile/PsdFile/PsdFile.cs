...
namespace PhotoshopFile
{
    ...
    public class PsdFile
    {
        ...
        public void LoadHeader(PsdBinaryReader reader)
        {
        ...
        public void LoadColorModeData(PsdBinaryReader reader)
        {
        ...
        public void LoadImageResources(PsdBinaryReader reader)
        {
        ...
        public void LoadLayerAndMaskInfo(PsdBinaryReader reader)
        {
        ...
        public byte[] GlobalLayerMaskData = new byte[0];

        public void LoadGlobalLayerMask(PsdBinaryReader reader)
        {
        ...
        public void LoadImage(PsdBinaryReader reader)
        {
        ...
        public class DecompressChannelContext
        {
            private Channel ch;
